...
<head>
    ...
    <script src="https://kit.fontawesome.com/9d07ce7098.js" crossorigin="anonymous"></script>
    <title>Gymsite Frontend Pages 1 & 2</title>
</head>
...
<!-- ***** Our Classes End ***** -->
    ...
    <section class="section" id="schedule">
        <div class="container">
         ...
         <!-- ***** Testimonials Starts - VIERNES ***** -->
         <section class="section" id="trainers_rgv">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
    ...
    <!-- ***** Contact Us Area Starts - VIERNES ***** -->
    <section class="section" id="contact-us_rgv">
    ...
    <!-- ***** Footer Start - VIERNES ***** -->
    <footer class="footer_rgv">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
